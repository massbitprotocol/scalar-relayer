...
pub mod axelar_gateway_proxy {
    ...
    pub static AXELARGATEWAYPROXY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct AxelarGatewayProxy<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for AxelarGatewayProxy<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for AxelarGatewayProxy<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for AxelarGatewayProxy<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for AxelarGatewayProxy<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AxelarGatewayProxy))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AxelarGatewayProxy<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                AXELARGATEWAYPROXY_ABI.clone(),
                AXELARGATEWAYPROXY_BYTECODE.clone().into(),
                client,
            );
    ...
    pub enum AxelarGatewayProxyErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for AxelarGatewayProxyErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for AxelarGatewayProxyErrors {
    ...
    impl ::ethers::contract::ContractRevert for AxelarGatewayProxyErrors {
    ...
    impl ::core::fmt::Display for AxelarGatewayProxyErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::InvalidImplementation(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for AxelarGatewayProxyErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<InvalidImplementation> for AxelarGatewayProxyErrors {
        fn from(value: InvalidImplementation) -> Self {
            Self::InvalidImplementation(value)
        }
    }
    impl ::core::convert::From<NativeCurrencyNotAccepted> for AxelarGatewayProxyErrors {
        fn from(value: NativeCurrencyNotAccepted) -> Self {
            Self::NativeCurrencyNotAccepted(value)
        }
    }
    impl ::core::convert::From<SetupFailed> for AxelarGatewayProxyErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum AxelarGatewayProxyCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for AxelarGatewayProxyCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for AxelarGatewayProxyCalls {
    ...
    impl ::core::fmt::Display for AxelarGatewayProxyCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<GetAddressCall> for AxelarGatewayProxyCalls {
        fn from(value: GetAddressCall) -> Self {
            Self::GetAddress(value)
        }
    }
    impl ::core::convert::From<GetBoolCall> for AxelarGatewayProxyCalls {
        fn from(value: GetBoolCall) -> Self {
            Self::GetBool(value)
        }
    }
    impl ::core::convert::From<GetBytesCall> for AxelarGatewayProxyCalls {
        fn from(value: GetBytesCall) -> Self {
            Self::GetBytes(value)
        }
    }
    impl ::core::convert::From<GetIntCall> for AxelarGatewayProxyCalls {
        fn from(value: GetIntCall) -> Self {
            Self::GetInt(value)
        }
    }
    impl ::core::convert::From<GetStringCall> for AxelarGatewayProxyCalls {
        fn from(value: GetStringCall) -> Self {
            Self::GetString(value)
        }
    }
    impl ::core::convert::From<GetUintCall> for AxelarGatewayProxyCalls {
        fn from(value: GetUintCall) -> Self {
            Self::GetUint(value)
        }
    }
    impl ::core::convert::From<SetupCall> for AxelarGatewayProxyCalls {
